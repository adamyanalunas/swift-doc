...
let package = Package(
    ...
    dependencies: [
        .package(name: "SwiftSyntax", url: "https://github.com/apple/swift-syntax.git", .exact("release/5.5")),
        .package(url: "https://github.com/SwiftDocOrg/SwiftSemantics.git", .exact("0.3.2")),
        ...
        .package(url: "https://github.com/NSHipster/SwiftSyntaxHighlighter.git", .exact("1.2.4")),
